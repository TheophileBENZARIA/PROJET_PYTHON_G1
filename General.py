...
class CaptainBraindead(General):
    ...
    Comportement :
    - Ne donne aucun ordre de mouvement
    - Ne donne aucun ordre d'attaque proactive
    - Ses unités restent en position défensive
    - Réagit seulement aux attaques ennemies
